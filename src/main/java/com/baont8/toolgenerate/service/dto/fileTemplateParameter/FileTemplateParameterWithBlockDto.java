...
public class FileTemplateParameterWithBlockDto {
	...
	private List<FileTemplateParameterWithBlockDto> fileTemplateParameters;
	...
	public List<FileTemplateParameterWithBlockDto> getFileTemplateParameters() {
		return fileTemplateParameters;
	}

	public void setFileTemplateParameters(List<FileTemplateParameterWithBlockDto> fileTemplateParameters) {
